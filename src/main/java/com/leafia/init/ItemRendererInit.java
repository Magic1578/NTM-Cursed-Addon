...
public class ItemRendererInit {
	...
	private static void register(boolean doFix,Item item,ItemRenderBase renderer) { register(item,renderer); }
	private static void register(boolean doFix,Block block,ItemRenderBase renderer) { register(block,renderer); }
